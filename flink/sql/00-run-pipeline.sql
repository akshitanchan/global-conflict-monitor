-- ==============================================
-- phase 2: one-session pipeline
-- creates source + sinks, then starts streaming inserts
-- ==============================================

-- 0) cdc source
-- (paste your existing create-cdc-source.sql content here, unchanged)
-- ------------------------------------------------
...
-- 2) streaming aggregations (keep session alive)
-- ------------------------------------------------
